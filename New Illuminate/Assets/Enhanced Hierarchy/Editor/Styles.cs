...
namespace EnhancedHierarchy {
    ...
    public static class Styles {
        ...
        static Styles() {
            ...
            monobehaviourIconTexture = Utility.FindOrLoad(monobehaviourIcon, "eh_icon_white_monobehaviour");

            var offTexture = Utility.FindOrLoad(lockOff, "eh_icon_white_lock_off");
            var onTexture = Utility.FindOrLoad(lockOn, "eh_icon_white_lock_on");
            lockToggleStyle = Utility.CreateStyleFromTextures(onTexture, offTexture);

            offTexture = Utility.FindOrLoad(activeOff, "eh_icon_white_enabled_off");
            onTexture = Utility.FindOrLoad(activeOn, "eh_icon_white_enabled_on");
            activeToggleStyle = Utility.CreateStyleFromTextures(onTexture, offTexture);

            offTexture = Utility.FindOrLoad(rendererOff, "eh_icon_white_renderer_off");
            onTexture = Utility.FindOrLoad(rendererOn, "eh_icon_white_renderer_on");
            rendererToggleStyle = Utility.CreateStyleFromTextures(onTexture, offTexture);

            offTexture = Utility.FindOrLoad(staticOff, "eh_icon_white_static_off");
            onTexture = Utility.FindOrLoad(staticOn, "eh_icon_white_static_on");
            staticToggleStyle = Utility.CreateStyleFromTextures(onTexture, offTexture);

            onTexture = Utility.FindOrLoad(tag, "eh_icon_white_tag");
            ...
            onTexture = Utility.FindOrLoad(layers, "eh_icon_white_layer");
            ...
            treeLineTexture = Utility.FindOrLoad(treeLine, "eh_tree_line");
            treeMiddleTexture = Utility.FindOrLoad(treeMiddle, "eh_tree_middle");
            treeEndTexture = Utility.FindOrLoad(treeEnd, "eh_tree_end");

            infoIcon = Utility.FindOrLoad(info, "eh_icon_color_info");
            warningIcon = Utility.FindOrLoad(warning, "eh_icon_color_warning");
            errorIcon = Utility.FindOrLoad(error, "eh_icon_color_error");

            fadeTexture = Utility.FindOrLoad(fade, "eh_fade");
            ...
            onTexture = Utility.FindOrLoad(childToggleOn, "eh_icon_white_child_expand_on");
            offTexture = Utility.FindOrLoad(childToggleOff, "eh_icon_white_child_expand_off");
        ...
        private const string treeMiddle = "iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMklEQVQ4EWP8//8/AxEApIgRmzombIKkiI0awMAw8GHAQkKUYU0wpBgwmpBwhPbApwMAL00FIa1Ycy8AAAAASUVORK5CYII=";
        ...
        private const string treeEnd = "iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAANUlEQVQ4EWP8//8/AxEApIgRmzombIKkiI0awMAwDMKAhYQ4x5riiDUAayoEWT4MAnHgvQAA7T4FIQ1dYzoAAAAASUVORK5CYII=";
